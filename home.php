...
?>
   ...
   <input id="hname" name="hname" type="hidden" value=" <?php echo $row['hname'];?>">
   <input id="hreference" name="hreference" type="hidden" value=" <?php echo $row['hreference'];?>">
<button class="btn btn-primary btn-xs" data-title="Edit" data-toggle="modal" data-target="#edit" name="edit" id="edit">Book <span class="glyphicon glyphicon-ok"></span></button>
